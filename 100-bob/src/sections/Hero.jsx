  ...
  return (
    <section className="hero" style={heroStyle}>
      ...
      <div className="hero__triangle-container">
          <svg width="788" height="500" viewBox="0 0 788 500" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero__triangle">
              ...
              <defs>
                  <linearGradient id="paint0_linear_15_518" x1="245.5" y1="-732" x2="245.5" y2="1231" gradientUnits="userSpaceOnUse">
                      <stop offset="0.456731" stop-color="#F5F5F5"/>
                      <stop offset="0.620192"/>
                  </linearGradient>
              </defs>
          </svg>
      </div>
